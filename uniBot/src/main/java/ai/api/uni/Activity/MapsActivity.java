...
import ai.api.uni.Task.GetNearbyPlacesData;
import ai.api.uni.R;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    private String getUrl(double latitude, double longitude, String nearbyPlace) {
        ...
        googlePlacesUrl.append("&key=" + /*Google API key*/);
    ...
    public void onLocationChanged(Location location) {
        ...
        DataTransfer[1] = url;
        Log.d("onClick", url);
        GetNearbyPlacesData getNearbyPlacesData = new GetNearbyPlacesData(this, keyword);
